      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-black/40 backdrop-blur-sm p-8 rounded-xl text-white text-center hover:bg-black/50 transition-colors">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <a 
              ...
              target="_blank" 
              className="flex flex-col items-center bg-black/40 backdrop-blur-sm p-8 rounded-xl text-white text-center hover:bg-black/50 transition-colors"
            >
